...
componentDidMount(){
  fetch('https://api.themoviedb.org/3/movie/top_rated?api_key=22ba39d2694d2cec259cd5896844c6f1&language=en-US&page=1')
  .then(res=>res.json())
  .then(res=>{
    this.setState({
      users:res.results,
  ...
  if(loading){
    ...
    return (
             <ScrollView>
               ...
               <Text style={{color:'#3498db',fontSize:30}}> Mejor Valoradas</Text>
